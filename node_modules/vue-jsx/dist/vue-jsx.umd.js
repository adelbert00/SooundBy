(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-jsx"] = factory();
	else
		root["vue-jsx"] = factory();
...
var jsx = {
  ...
  create: function create() {
    ...
    if (plen > 1) {
      ...
      var second = params[1];
      var i = 1;
      var secondIsObjeect = Object.prototype.toString.call(second).slice(8, -1) === 'Object'; // 如果第二个参数是 props
    ...
    if ('classes' in node.props) {
      node.props.classes.split(' ').forEach(function (cls) {
    ...
    if ('vmodel' in node.props) {
      var _node$props$vmodel = _slicedToArray(node.props['vmodel'], 4),
          context = _node$props$vmodel[0],
          model = _node$props$vmodel[1],
          modelProp = _node$props$vmodel[2],
          modelEvent = _node$props$vmodel[3];

      var tag = node.tag;
      var props = node.props;
      var inputType = props['attrs']['type'] || props['domProps']['type'] || 'text';
      var isInput = tag === 'input';
      var isText = isInput && ['text', 'hidden', 'password', 'number'].includes(inputType) || tag === 'textarea';
      ...
      if (isText) {
        ...
        if (Array.isArray(jsx.getProp(context, model))) {//- 好像有点麻烦，需要反推option children
          ...
          props['on'][modelEvent] = function (val) {
    ...
    ['class', 'style', 'attrs', 'props', 'domProps', 'on', 'nativeOn'].forEach(function (key) {
  ...
  bind: function bind(tag) {
    return function () {
      ...
      return jsx.create.apply(jsx, params);
    };
  }
};
'a,b,button,dd,div,dl,dt,em,form,i,iframe,img,input,textarea,label,li,ol,optgroup,option,p,select,span,table,th,thead,tbody,tr,td,col,colgroup,ul,h1,h2,h3,h4,h5,h6'.split(',').forEach(function (tag) {
  jsx[tag] = jsx.bind(tag);
});
/* harmony default export */ var src = (jsx);
...
//# sourceMappingURL=vue-jsx.umd.js.map