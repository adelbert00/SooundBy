    ...
    <section class="mx-auto w-[360px] md:w-full md:max-w-4xl xl:max-w-7xl">
      ...
      >
        ...
        <div class="mt-8 rounded-lg bg-transparent p-8 shadow-xl">
          <h2
            class="mb-6 text-center font-playfair text-2xl font-bold xl:text-4xl"
            data-aos="fade-right"
          >
            Moje Podejście do Kompozycji Muzyki
          </h2>
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2" data-aos="fade-up">
            <div class="rounded-lg p-6 shadow-md" data-aos="zoom-in">
              <h3
                class="mb-4 font-playfair text-2xl font-semibold text-gray-200"
              >
                Kluczowe Aspekty
              </h3>
              <ul
            ...
            <div class="rounded-lg p-6 shadow-md" data-aos="zoom-in">
              ...
              <ol
                class="list-inside list-decimal space-y-2 font-lato text-lg text-gray-300"
              >
                ...
                <li>Aranżacja i orkiestracja</li>
                <li>Nagrywanie i produkcja</li>
                <li>Miksowanie i mastering</li>
                <li>Prezentacja klientowi i wdrażanie feedbacku</li>
              </ol>
            </div>
          </div>
        </div>
...
import { musicList } from '../constants/music-List.ts';
